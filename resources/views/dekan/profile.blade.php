...
<x-layout :authUser='$authUser'>
    ...
    <form action="{{ route('update-profile-dekan', $authUser->id) }}" enctype="multipart/form-data" method="POST"
        ...
        {{-- <div class="mb-6">
            ...
            @if ($edit)
                <input
                    ...
                    aria-describedby="file_input_help" id="ttd" type="file" name="ttd"
                    accept=".png" max-size="2048">
        ...
        <div class="col-span-2 flex w-full justify-center gap-2 items-center mx-auto mt-0">
            ...
            <a class="bg-rose-600 p-2 text-white font-medium hover:bg-rose-700  rounded-lg flex {{ $edit ? 'hidden' : '' }}"
                href="/dekan/profile/reset-password">
