...
<x-layout :authUser='$authUser'>
    ...
    <form action="{{ route('staff-dekan-store-surat-tugas-kelompok', $jenisSurat->slug) }}" method="POST"
        ...
        <div x-data="{ lecturers: [{ name: '', nip: '', rank: '', position: '' }] }" class=" mb-6  ">
                        ...
                        <div>
                            <label :for="'pangkat-dosen-' + index"
                                class="block mb-2 text-sm font-medium text-gray-900">Pangkat/golongan<span
                                    class="text-red-500">*</span></label>
                            <input type="text" :name="`pangkat-dosen[]`" :id="'pangkat-dosen-' + index"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="Contoh: Penata/IIIc" x-model="lecturer.rank" required>
                        </div>
                        <div>
            ...
            <div class="mt-4">
                <button type="button" @click="lecturers.push({ name: '', nip: '', rank: '', position: '' })"
