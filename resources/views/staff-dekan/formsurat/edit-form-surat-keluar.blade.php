...
<x-layout :authUser='$authUser'>
    ...
    <form action="{{ route('update-surat-staff-dekan', $surat->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid gap-6 mb-2 md:grid-cols-2 bg-slate-100 p-4 rounded-lg ">
            <div class="md:col-span-2">
                ...
                <label for="paragraf-akhir"
                    class="block mb-2 text-sm italic font-medium text-gray-500 dark:text-white">Pastikan tidak ada baris
                    kosong di awal atau akhir teks editor </label>
                <label for="paragraf-awal"
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2 bg-slate-100 p-4 rounded-lg">
            ...
            <div class="md:col-span-2 mt-4">
                <label for="paragraf-akhir"
                    ...
                    Bagian Akhir (keterangan tambahan sebelum kalimat penutup dinas)<span
        ...
        <div x-data="{ tembusan: {{ json_encode($surat->data['private']['tembusan'] ?? []) }} }" class="bg-slate-100 p-4 mb-6 rounded-lg">
