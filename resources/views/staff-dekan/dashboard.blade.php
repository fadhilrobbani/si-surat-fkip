...
<x-layout :authUser='$authUser'>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
        <a href="/staff-dekan/surat-masuk">
            <div
                class="flex items-center gap-2 flex-col hover:bg-slate-300 justify-center rounded p-4  bg-gray-50 h-full dark:bg-gray-800">
        ...
        <a href="/staff-dekan/riwayat-persetujuan">
            <div
                class="flex items-center gap-2 flex-col hover:bg-slate-300 justify-center rounded p-4  bg-gray-50 h-full dark:bg-gray-800">
        ...
        <a href="/staff-dekan/riwayat-pengajuan-surat">
            <div
                class="flex items-center  gap-2 flex-col hover:bg-slate-300 justify-center rounded p-4  bg-gray-50 h-full dark:bg-gray-800">
        ...
        <a href="/staff-dekan/profile">
            <div
                class="flex items-center gap-2 flex-row hover:bg-slate-300 mb-4 justify-center rounded p-4  bg-gray-50 h-full dark:bg-gray-800">
            ...
            <div id="accordion-color-body-1" class="hidden" aria-labelledby="accordion-color-heading-1">
                <div class="p-5 border border-b-0 w-full border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                    <ol class="max-w-md space-y-1 text-gray-500 list-decimal list-inside dark:text-gray-400">
                        ...
                        <li>
                            Surat dari staff dekan (Anda) biasanya akan dikirim lagi ke staff dekan. Maka dari itu Anda
                            dapat
                            memeriksa bagian surat masuk secara berkala untuk menyetujui surat yang diajukan oleh anda
                            sendiri.
                        </li>
                    </ol>
