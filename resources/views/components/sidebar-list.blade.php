...
@if (!$list['dropdown'])
    <li>
        <a href="/{{ $list['link'] }}"
            class="{{ request()->is($list['link']) ? 'bg-slate-300' : '' }} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-slate-200 dark:hover:bg-gray-700 group">
