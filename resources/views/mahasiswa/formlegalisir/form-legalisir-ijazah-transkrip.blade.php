...
<x-layout :authUser='$authUser'>
    <x-slot:title>
        Mahasiswa | Pengajuan Legalisir Ijazah & Transkrip
    </x-slot:title>
    <x-slot:script>
        <script>
...
`;
    ...
    <p class="font-bold text-lg mx-auto text-center mb-2">Pengajuan Legalisir Ijazah & Transkrip </p>
    ...
    <form action="{{ route('store-pengajuan-legalisir', $jenisSurat->slug) }}" method="POST"
        ...
        <div class="bg-slate-50 p-4 rounded-lg shadow-lg">
            <div class="grid gap-6  md:grid-cols-2">
                ...
                <div>
                    <label for="jumlah-lembar-ijazah"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jumlah Lembar
                        Legalisir Ijazah (Maksimal 10 Lembar)<span class="text-red-500">*</span></label>
                    <input type="number" id="jumlah-lembar-ijazah" min="1" max="10" name="jumlah-lembar-ijazah"
                        class="bg-gray-50 border  border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="(Maksimal 10 lembar)" value="{{ old('jumlah-lembar-ijazah') }}" required>
                </div>
                <div>
                    <label for="jumlah-lembar-transkrip"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jumlah Lembar
                        Legalisir Transkrip (Maksimal 10 Lembar)<span class="text-red-500">*</span></label>
                    <input type="number" id="jumlah-lembar-transkrip" min="1" max="10" name="jumlah-lembar-transkrip"
                        class="bg-gray-50 border  border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="(Maksimal 10 lembar)" value="{{ old('jumlah-lembar-transkrip') }}" required>
                </div>
                <div>
        ...
        <select id="pengiriman" name="pengiriman"
            ...
            onchange="toggleShippingInputs()" disabled>
