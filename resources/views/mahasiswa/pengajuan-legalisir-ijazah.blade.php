            ...
            <div class="grid gap-6  md:grid-cols-2">
                ...
                <div>
                    <label for="jumlah-lembar"
                        ...
                        Legalisir<span class="text-red-500">*</span></label>
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div id="infoModalHelpOngkirURL" class="fixed inset-0 flex items-center justify-center hidden mx-2 ">
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-96 relative">
                        ...
                        <p class="mt-2 text-sm text-gray-700 dark:text-gray-300">Anda dapat mengecek ongkos kirim
                            melalui situs resmi JNE di <a href="https://www.jne.co.id" target="_blank"
                                class="text-blue-500 underline">www.jne.co.id</a>.</p>
