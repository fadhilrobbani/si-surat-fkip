...
<x-layout :authUser='$authUser'>
    ...
    <p class="font-bold text-lg mx-auto text-center mb-2">Surat Keterangan Eligible PIN</p>
    <form action="{{ route('store-surat', $jenisSurat->slug) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <div>
                <label for="periode-wisuda" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Periode
                    Wisuda<span class="text-red-500">*</span></label>
                <input type="number" id="periode-wisuda" name="periode-wisuda"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Contoh: 101" value="{{ old('periode-wisuda') }}" required>
            </div>
            <div>
