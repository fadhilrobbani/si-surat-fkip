        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <div>
                <label for="tempat-penelitian"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tempat Observasi<span
                        class="text-red-500">*</span></label>
            ...
            <div>
                <label for="waktu-mulai-penelitian"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Waktu Mulai Observasi<span
                        class="text-red-500">*</span></label>
                <input type="date" id="waktu-mulai-penelitian" name="waktu-mulai-penelitian"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Pilih waktu kapan Anda akan memulai observasi"
                    value="{{ old('waktu-mulai-penelitian') }}" required>
            </div>
            <div>
                <label for="waktu-selesai-penelitian"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Waktu Selesai Observasi<span
                        class="text-red-500">*</span></label>
                <input type="date" id="waktu-selesai-penelitian" name="waktu-selesai-penelitian"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Pilih waktu kapan Anda akan selesai dalam observasi"
