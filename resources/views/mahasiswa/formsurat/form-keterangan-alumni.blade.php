        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <div>
                <label for="tahunAkademikAwal"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tahun Akademik (Awal) / Tahun
            ...
            <div>
                <label for="tahunAkademikAkhir"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tahun Akademik (Akhir) / Tahun
                    Lulus Kuliah<span class="text-red-500">*</span></label>
            ...
            <div>
                ...
                <input
                    ...
                    aria-describedby="file_input_help" id="file_input" type="file" required name="ijazah"
