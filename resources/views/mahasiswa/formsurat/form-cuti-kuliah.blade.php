...
<x-layout :authUser='$authUser'>
    ...
    <form class="mt-4" method="POST">
        ...
        <select id="countries"
            ...
            <option value="aktif_kuliah" selected>Surat Keterangan Aktif Kuliah</option>
            <option value="cuti">Surat Izin Cuti</option>
            <option value="magang">Surat Izin Magang</option>
