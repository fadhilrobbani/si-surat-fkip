...
<x-layout :authUser='$authUser'>
    ...
    <p class="font-bold text-lg mx-auto text-center mb-2">Surat Permohonan Izin Penelitian</p>
    <form action="{{ route('store-surat', $jenisSurat->slug) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <div>
                <label for="tempat-penelitian"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tempat Penelitian<span
                        class="text-red-500">*</span></label>
                <input type="text" name="tempat-penelitian"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Contoh:  SMA Negeri 365 Kota Bengkulu" value="{{ old('tempat-penelitian') }}"
                    required>
            </div>
            <div>
                <label for="waktu-mulai-penelitian"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Waktu Mulai Penelitian<span
                        class="text-red-500">*</span></label>
                <input type="date" id="waktu-mulai-penelitian" name="waktu-mulai-penelitian"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Pilih waktu kapan Anda akan memulai penelitian"
                    value="{{ old('waktu-mulai-penelitian') }}" required>
            </div>
            <div>
                <label for="waktu-selesai-penelitian"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Waktu Selesai Penelitian<span
                        class="text-red-500">*</span></label>
                <input type="date" id="waktu-selesai-penelitian" name="waktu-selesai-penelitian"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Pilih waktu kapan Anda akan selesai dalam penelitian"
                    value="{{ old('waktu-selesai-penelitian') }}" required>
            </div>
            ...
            <div>
                ...
                <input
                    ...
                    accept=".pdf" max-size="2048" required>
