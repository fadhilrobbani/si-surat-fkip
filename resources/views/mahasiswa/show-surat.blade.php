        ...
        <div>
            <ol class="relative mx-8 text-gray-500 border-l border-gray-200 dark:border-gray-700 dark:text-gray-400">
                <li class="mb-10 ml-6">
                    ...
                    <h3 class="font-medium leading-tight">Mahasiswa</h3>
                    <p class="text-sm">Berhasil Mengajukan</p>
                </li>
                <li class="mb-10 ml-6">

                    @if (
                        $surat->current_user->role->id == 4 ||
                            $surat->current_user->role->id == 5 ||
                            $surat->current_user->role->id == 6 ||
                            $surat->current_user->role->id == 2)
                        <span
                            class="absolute flex items-center justify-center w-8 h-8 bg-green-200 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-green-900">
                            <svg class="w-3.5 h-3.5 text-green-500 dark:text-green-400" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                    ...
                    @elseif ($surat->status == 'denied')
                        <span
                            ...
                            <svg class="w-3.5 h-3.5 text-rose-700 dark:text-rose-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                              </svg>

                        </span>
                        <h3 class="font-medium leading-tight">Staff</h3>
                        <p class="text-sm">{{ $surat->current_user->role->id == 3 ? 'Ditolak' : 'Gagal Diteruskan' }}</p>
                    @else
                        <span
                            class="absolute flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-gray-700">
                            <svg class="w-3.5 h-3.5 text-gray-500 dark:text-gray-400" aria-hidden="true"
                ...
                <li class="mb-10 ml-6">
                    ...
                    @if ($surat->current_user->role->id == 5 || $surat->current_user->role->id == 6 || $surat->current_user->role->id == 2)
                        <span
                            class="absolute flex items-center justify-center w-8 h-8 bg-green-200 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-green-900">
                            <svg class="w-3.5 h-3.5 text-green-500 dark:text-green-400" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                    ...
                    @elseif ($surat->status == 'denied')
                        ...
                        <h3 class="font-medium leading-tight">Kaprodi</h3>
                        <p class="text-sm">{{ $surat->current_user->role->id == 4 ? 'Ditolak' : 'Gagal Diteruskan' }}</p>
                    @else
                        <span
                            class="absolute flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-gray-700">
                            <svg class="w-3.5 h-3.5 text-gray-500 dark:text-gray-400" aria-hidden="true"
                ...
                <li class="mb-10 ml-6">
                    ...
                    @if ($surat->current_user->role->id == 6 || $surat->current_user->role->id == 2)
                        ...
                        <h3 class="font-medium leading-tight">Wakil Dekan 1</h3>
                        <p class="text-sm">{{ $surat->current_user->role->id == 5 ? 'Ditolak' : 'Gagal Diteruskan' }}</p>
                    @else
                        <span
                            class="absolute flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-gray-700">
                            <svg class="w-3.5 h-3.5 text-gray-500 dark:text-gray-400" aria-hidden="true"
                ...
                <li class="ml-6">
                    ...
                    @if ($surat->current_user->role->id == 2)
                        ...
                        <h3 class="font-medium leading-tight">Akademik</h3>
                        <p class="text-sm">{{  $surat->current_user->role->id  == 6 ? 'Ditolak' : 'Gagal Diteruskan' }}</p>
                    @else
                        <span
                            class="absolute flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full -left-4 ring-4 ring-white dark:ring-gray-900 dark:bg-gray-700">
                            <svg class="w-3.5 h-3.5 text-gray-500 dark:text-gray-400" aria-hidden="true"
