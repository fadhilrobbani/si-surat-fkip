...
<x-layout :authUser='$authUser'>
    <x-slot:title>
        WD2| Detail Riwayat Persetujuan
    </x-slot:title>
                            ...
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    {{-- <a class="text-blue-700 underline"
                                        href="{{ route('show-file-wd2', ['surat' => $approval->surat->id, 'filename' => basename($value)]) }}">Lihat</a> --}}
                                    {{-- <a class="text-blue-700 underline"
    ...
    @if ($approval->surat->jenisSurat->slug != 'berita-acara-nilai')
        @if ($approval->surat->status == 'selesai')
            <a href="{{ route('print-surat-wd2', $approval->surat->id) }}"><button type="button"
        ...
        @else
            <a href="{{ route('preview-surat-wd2', $approval->surat->id) }}"><button type="button"
