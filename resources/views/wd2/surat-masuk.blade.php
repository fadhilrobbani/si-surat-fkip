            ...
            <div
                ...
                <div class="flex items-center space-x-3 w-full md:max-w-[150px] md:w-auto">
                    ...
                    <select id="program-studi" name="program-studi"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option value="" selected>Program Studi (Semua)</option>
                        @foreach ($daftarProgramStudi as $programStudi)
                            <option {{ $programStudi->id == request()->get('program-studi') ? 'selected' : '' }}
                ...
                <script>
                    const resetFilter = () => {
                        ...
                        document.getElementById('program-studi').value = null;
                    ...
                    <tbody>
                        @foreach ($daftarSuratMasuk as $surat)
                            ...
                            <tr class=" border-b dark:border-gray-700 hover:bg-slate-100">
                                ...
                                <td class="px-4 py-3">
                                    {{ $surat->jenisSurat->user_type == 'mahasiswa' ? ($surat->data['npm'] ?? $surat->data['username'] ?? $surat->pengaju->username ?? '-') : ($surat->data['username'] ?? $surat->pengaju->username ?? '-') }}
                                </td>
                                ...
                                <td class="px-4 py-3 flex ">
                                    ...
                                    <a href="{{ route('show-surat-wd2', $surat->id) }}">
                                        <div
