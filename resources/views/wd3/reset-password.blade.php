...
<x-layout :authUser='$authUser'>
    <x-slot:title>
        WD3 | Atur Ulang Kata Sandi
    </x-slot:title>

    <h1 class="mx-auto text-center font-bold mb-2">Atur Ulang Kata Sandi</h1>

    <form action="{{ route('reset-password-wd3', $authUser->id) }}" method="POST"
        ...
        <div class="col-span-2 flex w-full justify-center gap-2 items-center mx-auto mt-0">
            <a class="bg-pink-700 p-2 text-white font-medium hover:bg-pink-800  rounded-lg flex " href="/wd3/profile">
