...
<x-layout :authUser='$authUser'>
    <x-slot:title>
        Staff WD2 | Edit Surat
    </x-slot:title>
    <h1 class="mx-auto text-center font-bold">Edit {{ $surat->jenisSurat->name }}</h1>
    <br>
    <form action="{{ route('update-surat-staff-wd2', $surat->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('put')
        ...
        <div class="flex justify-center gap-4">
            ...
            <button type="button" onclick="window.location.href='{{ route('show-surat-staff-wd2', $surat->id) }}'"
