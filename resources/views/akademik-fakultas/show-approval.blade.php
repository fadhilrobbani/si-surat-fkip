...
<x-layout :authUser='$authUser'>
    <x-slot:title>
        Akademik Fakultas | Detail Riwayat Persetujuan
    </x-slot:title>
                            ...
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    {{-- <a class="text-blue-700 underline"
                                        href="{{ route('show-file-akademik-fakultas', ['surat' => $approval->surat->id, 'filename' => basename($value)]) }}">Lihat</a> --}}
                                    {{-- <a class="text-blue-700 underline"
    ...
    @if ($approval->surat->status == 'selesai' && $approval->surat->jenisSurat->slug != 'legalisir-ijazah')
        <a href="{{ route('print-surat-akademik-fakultas', $approval->surat->id) }}"><button type="button"
    ...
    @elseif($surat->jenisSurat->slug != 'legalisir-ijazah')
        ...
        <p class="italic text-slate-500">Surat belum dapat dicetak selama surat belum selesai / disetujui
            akademik-fakultas</p>
    @endif
</x-layout>
