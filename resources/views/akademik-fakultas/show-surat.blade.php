...
<x-layout :authUser='$authUser'>
    <x-slot:title>
        Akademik Fakultas | Detail Surat
    </x-slot:title>
    ...
    <div class="flex flex-col gap-10 justify-evenly items-start">
                                ...
                                <tr class="border-b border-gray-200 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        {{-- <a class="text-blue-700 underline"
                                            href="{{ route('show-file-akademik-fakultas', ['surat' => $surat->id, 'filename' => basename($value)]) }}">Lihat</a> --}}
                                        {{-- <a class="text-blue-700 underline"
        ...
        @if (
            ...
            <form action="{{ route('setujui-surat-akademik-fakultas', $surat->id) }}" method="POST"
                    ...
                    {{-- <div class="w-full max-w-[400px]">
                        <label for="stempel"
                            ...
                            digunakan (Jika tidak sesuai/tidak muncul, Anda dapat mengubahnya di profil akun <a
                                class="underline text-blue-600" href="/akademik-fakultas/profile">di sini</a>)</label>
                ...
                <div class="flex mt-8 justify-between flex-col sm:flex-row ">
                    ...
                    <div class="flex flex-col sm:flex-row">
                        ...
                        <a href="{{ route('confirm-tolak-surat-akademik-fakultas', $surat->id) }}">
                            <div
                        ...
                        <form action="{{ route('setujui-surat-akademik-fakultas', $surat->id) }}" method="POST"
                            ...
                            <div class=" flex flex-col gap-4 mt-10 items-center justify-center">
                                <div class="w-full max-w-[400px]">
                                    ...
                                    <p class="mb-2 text-xs text-gray-500 dark:text-gray-400">(Isi dengan angka 0 jika
                                        mahasiswa memilih mengambil di tempat)</p>
