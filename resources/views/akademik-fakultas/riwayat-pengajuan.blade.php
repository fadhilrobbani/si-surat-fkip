...
<x-layout :authUser='$authUser'>
    <x-slot:title>
        Akademik Fakultas | Riwayat Pengajuan
    </x-slot:title>
                        ...
                        @foreach ($daftarPengajuan as $surat)
                            ...
                            <tr class=" border-b dark:border-gray-700 hover:bg-slate-100">
                                ...
                                <td class="px-4 py-3 flex ">
                                    ...
                                    <a href="{{ route('show-detail-pengajuan-surat-akademik-fakultas', $surat->id) }}">
                                        <div
                                    ...
                                    @if ($surat->status == 'diproses')
                                        <form
                                            ...
                                            action="{{ route('akademik-fakultas-destroy-surat', $surat->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('delete')
                                            <button type="submit">
