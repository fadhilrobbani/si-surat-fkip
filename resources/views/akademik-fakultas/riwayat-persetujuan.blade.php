...
<x-layout :authUser='$authUser'>
    <x-slot:title>
        Akademik Fakultas | Riwayat Persetujuan
    </x-slot:title>
        ...
        <form id="filter-form" method="GET"
            ...
            <div class="w-full md:w-1/2">
                <div class="flex items-center">
                    <label for="search" class="sr-only">Cari (Nama atau No. Surat)</label>
                    ...
                    <tbody>
                        @foreach ($daftarRiwayatSurat as $riwayatSurat)
                            ...
                            <tr class=" border-b dark:border-gray-700 hover:bg-slate-100">
                                ...
                                <td class="px-4 py-3">{{ $riwayatSurat->surat->data['npm'] ?? $riwayatSurat->surat->data['username'] ?? $riwayatSurat->surat->pengaju->username ?? '-' }}</td>
                                ...
                                <td class="px-4 py-3 flex ">
                                    ...
                                    <a href="{{ route('show-approval-akademik-fakultas', $riwayatSurat->id) }}">
                                        <div
