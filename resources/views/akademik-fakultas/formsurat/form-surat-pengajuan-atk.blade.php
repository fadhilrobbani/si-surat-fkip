...
<x-layout :authUser='$authUser'>
    <x-slot:title>
        Akademik Fakultas | Pengajuan Surat
    </x-slot:title>
    {{-- <x-breadcumb /> --}}
    {{ Breadcrumbs::render('akademik-fakultas-pengajuan-surat-form', $jenisSurat) }}
    <p class="font-bold text-lg mx-auto text-center mb-2">Kirim Pengajuan ATK</p>
    <form action="{{ route('akademik-fakultas-store-surat-pengajuan-atk', $jenisSurat->slug) }}" method="POST"
