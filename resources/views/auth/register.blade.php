...
<body class="bg-slate-50">
    <main class="mx-auto py-6 w-1/3 mt-20 bg-white shadow-lg justify-center items-center flex flex-col">
        ...
        <form class="flex justify-center mx-auto flex-col px-12  w-full">
            <div class="mb-6">
