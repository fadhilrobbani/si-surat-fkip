    ...
    <main class="mx-auto relative py-6 w-full md:w-1/2 bg-white shadow-lg justify-center items-center flex flex-col">
        <div class="flex flex-col justify-center items-center gap-2">
            ...
            <div class="flex flex-col gap-0 m-0 p-0">
                ...
                <h1 class=" text-md mt-0 text-slate-700  text-center mb-4 mx-auto">Silahkan masukkan password baru Anda
                </h1>
                <form action="{{ route('password.update') }}" method="POST">
                    ...
                    <button type="submit"
                        class="text-white mx-auto mt-4 w-full bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Update
                        Password</button>
                </form>
            </div>
