    ...
    <main class="mx-auto relative py-6 w-full md:w-3/4 bg-white shadow-lg justify-center items-center flex flex-col">
        <div class="flex flex-col justify-center items-center gap-2">
            ...
            <div class="flex flex-col gap-0 m-0 p-0">
                ...
                <h1 class=" text-md mt-0 text-slate-700  text-center mb-4 mx-auto">Jika Anda lupa password akun, Anda dapat mereset password dengan mengisi form reset password di bawah. <br>Kami akan mengirim link untuk Anda dapat mereset password via email yang terdaftar</h1>
                <h1 class=" text-md mt-0 text-slate-700  text-center mb-4 mx-auto"></h1>
                <form action="{{ route('password.email') }}" method="POST">
                    @csrf
                    @method('post')
                    <div class="mb-6">
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Masukkan Email yang terdaftar
                        </label>
