...
<x-layout :authUser='$authUser'>
    ...
    <form action="{{ route('update-profile-bendahara', $authUser->id) }}" method="POST"
        enctype="multipart/form-data" class="flex gap-2 justify-center flex-col w-full max-w-md mx-auto">
        @csrf
        @method('PUT')
        <div class="mb-6">
        ...
        <div class="mb-6">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">Format PNG transparan (Maks. 2 MB).</p>
        </div>
        ...
        <div class="flex w-full justify-center gap-2 items-center mx-auto mt-0">
            ...
            <a class="bg-rose-600 p-2 text-white font-medium hover:bg-rose-700 rounded-lg flex {{ $edit ? 'hidden' : '' }}"
                href="/bendahara/profile/reset-password">
