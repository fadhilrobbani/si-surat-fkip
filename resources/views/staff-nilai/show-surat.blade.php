...
<x-layout :authUser='$authUser'>
    ...
    <div class="flex flex-col gap-10 justify-evenly items-start">
        ...
        @if ($surat->current_user_id == auth()->user()->id && $surat->status == 'diproses')
            <form action="{{ route('setujui-surat-staff-nilai', $surat->id) }}" method="POST"
                ...
                <div class="flex mt-8 justify-center flex-col sm:flex-row ">
                    {{-- <a href="{{ route('preview-surat-staff-nilai', $surat->id) }}"><button type="button"
                    ...
                    <div class="flex flex-col sm:flex-row">
                        ...
                        <a href="{{ route('confirm-tolak-surat-staff-nilai', $surat->id) }}">
                            <div
