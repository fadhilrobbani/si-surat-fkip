...
<x-layout :authUser='$authUser'>
    <x-slot:title>
        Kemahasiswaan | Detail Surat
    </x-slot:title>
    @php
        $urlPath = request()->path();
    @endphp

    {{ Breadcrumbs::render('kemahasiswaan-show-pengajuan-surat', $surat) }}
    ...
    {{-- ACTION BAR UNTUK DETAIL RIWAYAT PENGAJUAN SURAT DARI KEMAHASISWAAN --}}
    @if ($surat->jenisSurat->user_type == 'kemahasiswaan' && $surat->jenisSurat->slug == 'surat-pengajuan-atk-kemahasiswaan')
