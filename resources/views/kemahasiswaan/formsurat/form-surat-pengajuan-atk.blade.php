...
<x-layout :authUser='$authUser'>
    <x-slot:title>
        Kemahasiswaan | Pengajuan Surat
    </x-slot:title>
    {{-- <x-breadcumb /> --}}
    {{ Breadcrumbs::render('kemahasiswaan-pengajuan-surat-form', $jenisSurat) }}
    <p class="font-bold text-lg mx-auto text-center mb-2">Kirim Pengajuan ATK</p>
    <form action="{{ route('kemahasiswaan-store-surat-pengajuan-atk', $jenisSurat->slug) }}" method="POST"
