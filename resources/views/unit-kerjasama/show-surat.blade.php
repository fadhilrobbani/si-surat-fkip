...
<x-layout :authUser='$authUser'>
    <x-slot:title>
        Unit Kerjasama | Detail Surat
    </x-slot:title>
    @php
        $urlPath = request()->path();
    @endphp

    {{ Breadcrumbs::render('unit-kerjasama-show-pengajuan-surat', $surat) }}
    ...
    {{-- ACTION BAR UNTUK DETAIL RIWAYAT PENGAJUAN SURAT DARI TATA USAHA --}}
    @if ($surat->jenisSurat->user_type == 'unit-kerjasama' && $surat->jenisSurat->slug == 'surat-pengajuan-atk-unit-kerjasama')
