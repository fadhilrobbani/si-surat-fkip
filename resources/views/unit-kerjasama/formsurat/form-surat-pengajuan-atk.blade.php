...
<x-layout :authUser='$authUser'>
    <x-slot:title>
        Unit Kerjasama | Pengajuan Surat
    </x-slot:title>
    {{-- <x-breadcumb /> --}}
    {{ Breadcrumbs::render('unit-kerjasama-pengajuan-surat-form', $jenisSurat) }}
    <p class="font-bold text-lg mx-auto text-center mb-2">Kirim Pengajuan ATK</p>
    <form action="{{ route('unit-kerjasama-store-surat-pengajuan-atk', $jenisSurat->slug) }}" method="POST"
