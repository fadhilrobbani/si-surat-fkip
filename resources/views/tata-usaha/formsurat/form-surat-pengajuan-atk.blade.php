...
<x-layout :authUser='$authUser'>
    <x-slot:title>
        Tata Usaha | Pengajuan Surat
    </x-slot:title>
    {{-- <x-breadcumb /> --}}
    {{ Breadcrumbs::render('tata-usaha-pengajuan-surat-form', $jenisSurat) }}
    <p class="font-bold text-lg mx-auto text-center mb-2">Kirim Pengajuan ATK</p>
    <form action="{{ route('tata-usaha-store-surat-pengajuan-atk', $jenisSurat->slug) }}" method="POST"
