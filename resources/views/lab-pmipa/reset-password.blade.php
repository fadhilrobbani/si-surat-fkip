...
<x-layout :authUser='$authUser'>
    <x-slot:title>
        Lab PMIPA | Atur Ulang Kata Sandi
    </x-slot:title>

    <h1 class="mx-auto text-center font-bold mb-2">Atur Ulang Kata Sandi</h1>

    <form action="{{ route('reset-password-lab-pmipa', $authUser->id) }}" method="POST"
        ...
        <div class="mb-6">
            <label for="password_confirmation" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Konfirmasi kata
                sandi baru
            </label>
