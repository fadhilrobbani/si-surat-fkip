...
<x-layout :authUser='$authUser'>
    <x-slot:title>
        Lab PMIPA | Pengajuan Surat
    </x-slot:title>
    {{ Breadcrumbs::render('lab-pmipa-pengajuan-surat-form', $jenisSurat) }}
    <p class="font-bold text-lg mx-auto text-center mb-2">Kirim Pengajuan ATK</p>
    <form action="{{ route('lab-pmipa-store-surat-pengajuan-atk', $jenisSurat->slug) }}" method="POST"
