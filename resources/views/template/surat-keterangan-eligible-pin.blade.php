...
<body>
    ...
    <br>
    <br>
    <p style="text-align: justify">Sehubungan dengan kemungkinan mahasiswa berikut akan diwisuda pada periode
        Ke-{{ $surat->data['periodeWisuda'] }}
        {{ ' ' . $surat->data['tanggalWisuda'] }}, maka Operator PDDIKTI Prodi {{ $surat->data['programStudi'] }} telah
        mengecek data mahasiswa
        tersebut dan yang
        bersangkutan dinyatakan Eligible PIN.
    </p>
    <br>
