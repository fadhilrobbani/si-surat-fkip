...
<x-layout :authUser='$authUser'>
    ...
    <p class="font-bold text-lg mx-auto text-center mb-2">Kirim Berita Acara Nilai</p>
    <form action="{{ route('staff-store-berita-acara-nilai', $jenisSurat->slug) }}" method="POST"
