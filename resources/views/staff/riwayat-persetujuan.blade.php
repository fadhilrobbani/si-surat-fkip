        ...
        <div
            ...
            <div class="flex items-center space-x-3 w-full max-w-[250px] md:w-auto">
                ...
                <select id="status" name="status"
                    ...
                    <option {{ request()->get('status') != 'ditolak' &&  request()->get('status')? 'selected' : ''  }} value="disetujui" >Disetujui</option>
                    <option  {{ request()->get('status') == 'ditolak' ? 'selected' :''}} value="ditolak" >Ditolak</option>
                ...
                <tbody>
                    @foreach ($daftarRiwayatSurat as $riwayatSurat)
                        ...
                        <tr class=" border-b dark:border-gray-700 hover:bg-slate-100">
                            ...
                            <td class="px-4 py-3">{{ $riwayatSurat->surat->pengaju->username }}</td>
                            ...
                            <td class="px-4 py-3 flex ">
                                ...
                                <a href="{{ route('show-approval-staff', $riwayatSurat->id) }}">
                                    <div
