...
class WD3Controller extends Controller
{
    ...
    public function updateProfile(Request $request, User $user)
    {
        ...
        return redirect('/wd3/profile')->with('success', 'Sukses mengupdate data');
    }
    ...
    public function setujuiSurat(Request $request, Surat $surat)
    {
        ...
        return redirect('wd3/surat-masuk')->with('success', 'Surat berhasil disetujui');
    }
    ...
    public function riwayatPersetujuan(Request $request)
    {
        ...
        return view('wd3.riwayat-persetujuan', [
    ...
    public function tolakSurat(Request $request, Surat $surat)
    {
        ...
        return redirect('/wd3/surat-masuk')->with('success', 'Surat berhasil ditolak');
    }

    public function resetPasswordPage()
    {
        return view('wd3.reset-password');
    }
    ...
    public function resetPassword(Request $request, User $user)
    {
        ...
        return redirect('/wd3/profile')->with('success', 'Kata sandi sukses diganti!');
    }
}
