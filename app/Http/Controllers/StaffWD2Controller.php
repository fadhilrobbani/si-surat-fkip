...
class StaffWD2Controller extends Controller
{
    public function dashboard()
    {
        return view('staff-wd2.dashboard', [
    ...
    public function updateProfile(Request $request, User $user)
    {
        ...
        return redirect('/staff-wd2/profile')->with('success', 'Sukses mengupdate data');
    }
    ...
    public function suratMasuk(Request $request)
    {
        ...
        return view('staff-wd2.surat-masuk', [
    ...
    public function showSuratMasuk(Surat $surat)
    {
        ...
        if ($surat->jenisSurat->user_type == 'staff' && $surat->jenisSurat->slug == 'berita-acara-nilai') {
            ...
            return view('staff-wd2.show-surat', [
                'surat' => $surat,
    ...
    public function setujuiSurat(Request $request, Surat $surat)
    {
        ...
        return redirect('/staff-wd2/surat-masuk')->with('success', 'Surat berhasil disetujui');
    }
    ...
    public function tolakSurat(Request $request, Surat $surat)
    {
        ...
        return redirect('/staff-wd2/surat-masuk')->with('success', 'Surat berhasil ditolak');
    }

    public function confirmTolakSurat(Surat $surat)
    {
        return view('staff-wd2.confirm-tolak', [
            'surat' => $surat
        ]);
    }
    ...
    public function riwayatPersetujuan(Request $request)
    {
        ...
        return view('staff-wd2.riwayat-persetujuan', [
    ...
    public function showApproval(Approval $approval)
    {
        ...
        return view('staff-wd2.show-approval', [
            'approval' => $approval,
    ...
    {
        return view('staff-wd2.reset-password');
    }
    ...
    public function resetPassword(Request $request, User $user)
    {
        ...
        return redirect('/staff-wd2/profile')->with('success', 'Kata sandi sukses diganti!');
    }
}
